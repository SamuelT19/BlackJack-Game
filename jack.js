...
const hitSound = new Audio('sounds/dealSound.wav')
const winSound = new Audio('sounds/winSound.wav')
const lossSound = new Audio('sounds/lossSound.wav')

document.querySelector('#blackjack-stand-button').addEventListener('click', dealerLogic);
document.querySelector('#blackjack-hit-button').addEventListener('click', blackjackHit);
document.querySelector('#blackjack-deal-button').addEventListener('click', blackjackDeal);
document.querySelector('#blackjack-hit-button').addEventListener('click', hitBust);
